...
const AboutDialog = forwardRef<AboutDialogRef, AboutDialogProps>(
  ({ forceDark = false }, ref) => {
    ...
    if (isDesktop) {
      return (
        <Dialog open={isOpen} onOpenChange={setIsOpen} aria-label="About CODEARC">
          <DialogContent className={cn('max-w-2xl', forceDark && 'dark')}>
            ...
            <div
              ...
              aria-label="CODEARC application preview"
            >
              <Image
                src="/images/cover.png"
                alt="CODEARC application interface preview"
    ...
    return (
      <Drawer open={isOpen} onOpenChange={setIsOpen} aria-label="About CODEARC">
        <DrawerContent>
          <DrawerHeader>
          ...
          <div className="w-full px-4" aria-label="CODEARC application preview">
